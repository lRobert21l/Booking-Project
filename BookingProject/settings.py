...
SECRET_KEY = 'django-insecure-m#h1inxnq^fbyclpbq*acdx_v*3v^78ri6-3r+kyhm@oe&c!)x'
...
MEDIA_URL = 'main/static/main/media/'
MEDIAFILES_DIRS = [
    os.path.join(BASE_DIR, 'main/static/main/media')
]
